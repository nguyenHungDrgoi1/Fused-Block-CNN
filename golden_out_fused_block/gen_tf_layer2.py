...
weight_file = "../Fused-Block-CNN/golden_out_fused_block/weight_hex_folder/weight2.hex"
output_file = "../Fused-Block-CNN/golden_out_fused_block/output_hex_folder/ofm2.hex"
