...
void write_to_file(const char *filename, const int16_t *input, int width, int height, int channels, const char *layer_name) {
...
int main() {
    ...
    write_to_file(output_file, input, INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, "Input");
   ...
   // write_to_file(output_file, output_residual, INPUT_WIDTH, INPUT_HEIGHT, INPUT_CHANNELS, "Final Output (Residual Addition)");
