...
int main() {
    ...
    int kernel_height = 3, kernel_channel = 1, kernel_filter = 3;
    ...
    float ***ofmap = DeepWise(ifmap, kernel, input_height, input_width, input_channel, kernel_height, kernel_filter, kernel_channel, stride, padding);
